...
public class TesteTrackerFuiAli {
	...
	@Test
	public void DeveClicarFuiAli() throws MalformedURLException, InterruptedException{
				
				//Clicar Almoço
				WebDriverWait wait = new WebDriverWait(driver, 10000);
				//System.out.println("teste4");
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Fui ali']")));
			   	MobileElement FuiAli = driver.findElement(By.xpath("//*[@text='Fui ali']"));
			   	System.out.println(FuiAli.getText());			    
			    FuiAli.click();
