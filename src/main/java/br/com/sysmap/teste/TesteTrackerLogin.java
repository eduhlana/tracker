...
public class TesteTrackerLogin {
	...
	public void DevePreencherCampoLogin() throws MalformedURLException, InterruptedException{
		//Capacidades
			    ...
			    java.util.List<MobileElement> ElementoEntrar = driver.findElements(By.className("android.widget.TextView"));
			   	...
			   	WebDriverWait waitAtividade = new WebDriverWait(driver, 10000);
			    waitAtividade.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@text='Novo Tracker']")));
			   	MobileElement Atividade = driver.findElement(By.xpath("//*[@text='Novo Tracker']"));
			    			    
			    Atividade.sendKeys("testeUltimo1");
			    
			    //Clicar para Iniciar Atividade
			    ...
			    ElementoClicarAtividade.get(4).click();
			    Thread.sleep(5000);
